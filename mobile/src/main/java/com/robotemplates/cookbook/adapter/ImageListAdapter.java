...
public class ImageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    private List<Image> mRecipeList;
    private List<Object> mFooterList;
    private ImageViewHolder.OnItemClickListener mListener;
    ...
    public ImageListAdapter(List<Image> recipeList, List<Object> footerList, ImageViewHolder.OnItemClickListener listener, int gridSpanCount)
    {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        if(viewType==VIEW_TYPE_RECIPE)
        {
            ...
            return new ImageViewHolder(view, mListener, mImageLoader, mDisplayImageOptions, mImageLoadingListener);
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position)
    {
        ...
        {
            // entity
            Image recipe = mRecipeList.get(getRecipePosition(position));

            // render view
            if(recipe != null)
            {
                ((ImageViewHolder) viewHolder).bindData(recipe);
            }
        }
    ...
    public void refill(List<Image> recipeList, List<Object> footerList, ImageViewHolder.OnItemClickListener listener, int gridSpanCount)
    {
        mRecipeList = recipeList;
        mFooterList = footerList;
        mListener = listener;
    ...
    public static final class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public ImageViewHolder(View itemView, OnItemClickListener listener, ImageLoader imageLoader, DisplayImageOptions displayImageOptions, ImageLoadingListener imageLoadingListener)
        {
            super(itemView);
            mListener = listener;
        ...
        public void bindData(Image recipe)
        {
//            nameTextView.setText(recipe.getName());
            mImageLoader.displayImage(recipe.getUrl(), imageView, mDisplayImageOptions, mImageLoadingListener);
        }
    }
